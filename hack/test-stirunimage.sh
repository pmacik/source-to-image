...
TEST_IMAGE="${TEST_IMAGE:-registry.redhat.io/ocp-tools-43-tech-preview/source-to-image-rhel8}"
...
echo "Running s2i as a docker container using the following command: \"$s2i\""
...
$s2i build "${S2I_WORK_DIR}/cakephp-ex" docker.io/centos/php-70-centos7 test --loglevel=5 &> "${WORK_DIR}/s2i-non-repo.log"
check_result $? ""
